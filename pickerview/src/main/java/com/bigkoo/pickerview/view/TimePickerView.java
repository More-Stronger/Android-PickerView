...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            if (mPickerOptions.dayIsShowWeek) {
                LayoutInflater.from(context).inflate(R.layout.pickerview_time_week, contentContainer);
            } else {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        ...
        wheelTime.setDayIsShowWeek(mPickerOptions.dayIsShowWeek);
        ...
        //提前设置日期label 方便日期显示周时label的显示
        wheelTime.setDayLabel(mPickerOptions.label_day);
        setTime();
