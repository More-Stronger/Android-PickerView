...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TimePickerView pvTime, pvTimeWeek, pvCustomTime, pvCustomLunar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_Time_Week = findViewById(R.id.btn_Time_Week);
        ...
        btn_Time_Week.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_Time_Week && pvTimeWeek != null) {
            pvTimeWeek.show(v);
    ...
    private void initTimePickerWeek() {//Dialog 模式下，在底部弹出
        pvTimeWeek = new TimePickerBuilder(this, new OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date, View v) {
                Toast.makeText(MainActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
                Log.i("pvTimeWeek", "onTimeSelect");
                ...
                .setTimeSelectChangeListener(new OnTimeSelectChangeListener() {
                    @Override
                    public void onTimeSelectChanged(Date date) {
                        Log.i("pvTimeWeek", "onTimeSelectChanged");
                    }
                })
                .setDayIsShowWeek(true)
                .setType(new boolean[]{true, true, true, true, true, true})
                .setLabel("年","月","日","时","分","秒")
                .isDialog(true) //默认设置false ，内部实现将DecorView 作为它的父控件。
                .build();

        Dialog mDialog = pvTimeWeek.getDialog();
        if (mDialog != null) {
            ...
            params.leftMargin = 0;
            params.rightMargin = 0;
            pvTimeWeek.getDialogContainerLayout().setLayoutParams(params);
